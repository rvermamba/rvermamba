            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    ...
                    <div class="navbar-container container-fluid">
                        <ul class="nav-left">
                            <li>
                                <div class="sidebar_toggle"><a href="<?php echo base_url(); ?>/javascript:void(0)"><i class="ti-menu"></i></a></div>
                            </li>

                            <li>
                                <a href="<?php echo base_url(); ?>/#!" onclick="javascript:toggleFullScreen()">
                        ...
                        <ul class="nav-right">
                            ...
                            <li class="user-profile header-notification">
                                ...
                                <ul class="show-notification profile-notification">
                                    ...
                                    <li>
                                        <a href="<?php echo base_url(); ?>/auth-normal-sign-in.html">
            ...
            <div class="pcoded-main-container">
                <div class="pcoded-wrapper">
                    <nav class="pcoded-navbar">
                        <div class="sidebar_toggle"><a href="<?php echo base_url(); ?>/#"><i class="icon-close icons"></i></a></div>
                        <div class="pcoded-inner-navbar main-menu">
                                ...
                                <div class="main-menu-content">
                                    <ul>
                                        <li class="more-details">
                                            <a href="<?php echo base_url(); ?>/#"><i class="ti-user"></i>View Profile</a>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="pcoded-hasmenu">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class=" ">
                                            <a href="<?php echo base_url(); ?>/accordion.html">
                                        ...
                                        <li class=" ">
                                            <a href="<?php echo base_url(); ?>/breadcrumb.html">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class=" ">
                                            <a href="<?php echo base_url(); ?>/button.html">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class=" ">
                                            <a href="<?php echo base_url(); ?>/tabs.html">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class=" ">
                                            <a href="<?php echo base_url(); ?>/color.html">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class=" ">
                                            <a href="<?php echo base_url(); ?>/label-badge.html">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class=" ">
                                            <a href="<?php echo base_url(); ?>/tooltip.html">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class=" ">
                                            <a href="<?php echo base_url(); ?>/notification.html">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class=" ">
                                            <a href="<?php echo base_url(); ?>/icon-themify.html">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li>
                                    <a href="<?php echo base_url(); ?>/form-elements-component.html">
                                ...
                                <li>
                                    <a href="<?php echo base_url(); ?>/bs-basic-table.html">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li>
                                    <a href="<?php echo base_url(); ?>/chart.html">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                ...
                                <li>
                                    <a href="<?php echo base_url(); ?>/map-google.html">
                                        <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                ...
                                <li class="pcoded-hasmenu">
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class=" ">
                                            <a href="<?php echo base_url(); ?>/auth-sign-up.html">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class=" ">
                                            <a href="<?php echo base_url(); ?>/sample-page.html">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                            ...
                                                            <div class="checkbox-fade fade-in-primary d-block">
                                                                <label class="check-task d-block">
                                                                    ...
                                                                    <div class="task-card-img m-l-40">
                                                                        <a href="<?php echo base_url(); ?>/#!"><img src="<?php echo base_url(); ?>/assets/images/avatar-2.jpg" data-toggle="tooltip" title="Lary Doe" alt="" class="img-40"></a>
                                                                        <a href="<?php echo base_url(); ?>/#!"><img src="<?php echo base_url(); ?>/assets/images/avatar-3.jpg" data-toggle="tooltip" title="Alia" alt="" class="img-40 m-l-10"></a>
                                                                    </div>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="to-do-list">
                                                            <div class="checkbox-fade fade-in-primary d-block">
                                                                <label class="check-task d-block">
                                                                    ...
                                                                    <div class="task-card-img m-l-40">
                                                                        <a href="<?php echo base_url(); ?>/#!"><img src="<?php echo base_url(); ?>/assets/images/avatar-2.jpg" data-toggle="tooltip" title="Alia" alt="" class="img-40"></a>
                                                                        <a href="<?php echo base_url(); ?>/#!"><img src="<?php echo base_url(); ?>/assets/images/avatar-3.jpg" data-toggle="tooltip" title="Suzen" alt="" class="img-40 m-l-10"></a>
                                                                        <a href="<?php echo base_url(); ?>/#!"><img src="<?php echo base_url(); ?>/assets/images/avatar-4.jpg" data-toggle="tooltip" title="Lary Doe" alt="" class="img-40 m-l-10"></a>
                                                                        <a href="<?php echo base_url(); ?>/#!"><img src="<?php echo base_url(); ?>/assets/images/avatar-2.jpg" data-toggle="tooltip" title="Josephin Doe" alt="" class="img-40 m-l-10"></a>
                                                                    </div>
                                                                </label>
                                                            </div>
                                                        </div>
                ...
                <div class="fixed-button">
                    <a href="<?php echo base_url(); ?>/https://codedthemes.com/item/guru-able-admin-template/" target="_blank" class="btn btn-md btn-primary">
...
<div class="ie-warning">
    ...
    <div class="iew-container">
        <ul class="iew-download">
            <li>
                <a href="<?php echo base_url(); ?>/http://www.google.com/chrome/">
                    <img src="<?php echo base_url(); ?>/assets/images/browser/chrome.png" alt="Chrome">
                    <div>Chrome</div>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url(); ?>/https://www.mozilla.org/en-US/firefox/new/">
                    <img src="<?php echo base_url(); ?>/assets/images/browser/firefox.png" alt="Firefox">
                    <div>Firefox</div>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url(); ?>/http://www.opera.com">
                    <img src="<?php echo base_url(); ?>/assets/images/browser/opera.png" alt="Opera">
                    <div>Opera</div>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url(); ?>/https://www.apple.com/safari/">
                    <img src="<?php echo base_url(); ?>/assets/images/browser/safari.png" alt="Safari">
                    <div>Safari</div>
                </a>
            </li>
            <li>
                <a href="<?php echo base_url(); ?>/http://windows.microsoft.com/en-us/internet-explorer/download-ie">
